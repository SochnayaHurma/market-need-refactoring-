                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" 
                            ...
                            class="form-control"
                            placeholder="Цена"
                            value="<?=$product[$current_lang]['price'] ?>">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" 
                            ...
                            value="<?=$product[$current_lang]['old_price']?>">
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="custom-control custom-checkbox">
                    <input 
                        ...
                        id="status"
                        <?= $product[$current_lang]['status']?'checked':''?>>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <?php if ($product[$current_lang]['is_download']):?>
                        ...
                        <select 
                            ...
                            style="width:100%">
                            <?php if ($product[$current_lang]['is_download'] && isset($product[$current_lang]['download_id'])): ?>
                                <option value="<?=$product[$current_lang]['download_id']?>" selected>
                                    <?=$product[$current_lang]['download_name']?>
                                </option>
                            <?php endif ?>
                        </select>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div id="base-img-output" class="upload-images base-image">
                                <div class="product-img-upload">
                                    <img width="100%" src="<?=$product[$current_lang]['img']?>"/>
                                    <input type="hidden" name="img" value="<?=$product[$current_lang]['img']?>"/>
                                    <?php if ($product[$current_lang]['img'] != NO_IMAGE): ?>
                    ...
                    <div class="card card-outline card-success">
                        ...
                        <div class="card-body">
                            ...
                            <div id="gallery-img-output" class="upload-images gallery-image">
                                <?php foreach($product[$current_lang]['gallery'] as $pic):?>
                                    <div class="product-img-upload">
                                        <img width="100%" src="<?=$pic?>">
                                        <input type="hidden" name="gallery[]" value="<?=$pic?>">
                                        <button class="del-img btn btn-app bg-danger">
                                            <i class="far fa-trash-alt"></i>
                                        </button>
                                    </div>
