            ...
            <form class="row g-3" method="post">
                ...
                <div class="col-md-6 offset-md-3">
                    <div class="form-floating mb-3">
                        <input type="email" name="email" value="<?= get_field_value('email');?>" class="form-control" id="email" placeholder="name@example.com">
                ...
                <div class="col-md-6 offset-md-3">
                    <button type="submit" class="btn btn-danger"><?= __('user_signup_signup_btn'); ?></button>
                </div>
            </form>
