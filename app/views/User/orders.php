...
<div class="container py-3">
    <div class="row">
        <div class="col-12">
            <h1 class="section-title"><?= ___('tpl_orders_title')?></h1>
        </div>
            ...
            <?php if (!empty($orders)): ?>
                <div class="table-responsive">
                    <table class="table text-start table-bordered">
                        <thead>
                            <tr>
                                <th scope="col"><?= ___('user_orders_num')?></th>
                                <th scope="col"><?= ___('user_orders_status')?></th>
                                <th scope="col"><?= ___('user_orders_total')?></th>
                                <th scope="col"><?= ___('user_orders_created')?></th>
                                <th scope="col"><?= ___('user_orders_updated')?></th>
                        ...
                        <tbody>
                            <?php foreach ($orders as $order) :?>
                                <tr <?php if ($order['status']) echo 'class="table-info"'?>>
                                    <td><?= $order['id']?></td>
                                    <td><?= ___("user_order_status_{$order['status']}")?></td>
                                    <td><?= $order['total']?></td>
