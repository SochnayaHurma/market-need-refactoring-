...
<div class="container py-3">
    <div class="row">
        ...
        <div class="col-lg-12 category-content">
            ...
            <?php endif; ?>
                <?php if (!empty($products) && $countProducts > 1):?>
            <div class="row">
                <div class="col-sm-6">
